...
{
    public class WebAppCreateTaskStory : CreateEntityStory<Domain.Entities.TaskEvent, WebAppCreateTaskStoryContext>, IStory<WebAppCreateTaskStoryContext, PartyMaker.Dto.WebApp.WebAppResponseDto>
    {
        ...
        protected async override System.Threading.Tasks.Task AfterRequest(WebAppCreateTaskStoryContext context, Guid id)
        {
