...
{
    public class WebAppRegistrationByInviteStoryContextToUserTranslator : AutomapperTranslator<WebAppRegistrationByInviteStoryContext, Domain.Entities.User>
    {
        public WebAppRegistrationByInviteStoryContextToUserTranslator(IMapperConfigurationExpression configurationExpression, Lazy<IMapper> mapper)
