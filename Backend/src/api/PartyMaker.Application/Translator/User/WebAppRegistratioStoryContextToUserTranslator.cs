...
{
    public class WebAppRegistratioStoryContextToUserTranslator : AutomapperTranslator<WebAppRegistrationStoryContext, Domain.Entities.User>
    {
        public WebAppRegistratioStoryContextToUserTranslator(IMapperConfigurationExpression configurationExpression, Lazy<IMapper> mapper)
