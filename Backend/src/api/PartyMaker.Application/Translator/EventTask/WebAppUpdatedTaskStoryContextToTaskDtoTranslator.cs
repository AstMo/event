...
{
    public class WebAppUpdatedTaskStoryContextToTaskDtoTranslator : AutomapperTranslator<WebAppUpdateTaskStoryContext, Domain.Entities.TaskEvent>
    {
        public WebAppUpdatedTaskStoryContextToTaskDtoTranslator(IMapperConfigurationExpression configurationExpression, Lazy<IMapper> mapper)
