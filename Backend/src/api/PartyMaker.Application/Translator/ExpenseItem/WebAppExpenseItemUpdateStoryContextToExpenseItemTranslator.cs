...
{
    public class WebAppExpenseItemUpdateStoryContextToExpenseItemTranslator : AutomapperTranslator<WebAppUpdateExpenseItemStoryContext, Domain.Entities.ExpenseItem>
    {
        public WebAppExpenseItemUpdateStoryContextToExpenseItemTranslator(IMapperConfigurationExpression configurationExpression, Lazy<IMapper> mapper)
